...
<div class="d-inline-flex bg-light border border-secondary tile tile_medium text-center rounded">
    <div class="flex-row w-100">
        <div class="pl-1 pr-1 text-light bg-dark w-100">
            <table class="p-0 m-0 w-100 text-center text-light popup_parent border position_relative">
                <tr>
                    <td class="">
                        <?=$head?>
                    </td>
